...
__Примечание__ после этх строк можно вызывать функции без префикса *math*. Если прописать отдельные функции в строке импорта и использовать другие без префикса *math*, то будет __ошибка__
